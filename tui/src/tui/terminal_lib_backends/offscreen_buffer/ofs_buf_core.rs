...
use crate::{GetMemSize, LockedOutputDevice, MemorySize, MouseTrackingMode, Pos, Size,
            TermRow, TuiStyle, osc::OscEvent};
use std::fmt::Debug;
...
impl OffscreenBuffer {
    ...
    pub fn resize(&mut self, arg_new_size: impl Into<Size>) {
        ...
        self.cursor_pos = crate::Pos {
            row_index: crate::row(cur_row),
            col_index: crate::col(cur_col),
        };

        self.memory_size = crate::MemorySize::new(
