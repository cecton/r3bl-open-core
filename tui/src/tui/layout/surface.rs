...
impl PerformPositioningAndSizing for Surface {
    ...
    fn update_insertion_pos_for_next_box(
        ...
        let new_pos: Pos = match current_box.dir {
            LayoutDirection::Vertical => Pos::from((new_pos.row_index, current_insertion_pos.col_index)),
            LayoutDirection::Horizontal => Pos::from((current_insertion_pos.row_index, new_pos.col_index)),
        };
