...
### Phase 23: Implement ScopedMutex (Scoped Access pattern) [REVIEW-CODE]
...
- [ ] **Mandatory manual review:** Verify every file modified in this phase for correct
  ...
  - [ ] `tui/src/core/ansi/terminal_raw_mode/raw_mode_unix.rs`
  - [ ] `tui/src/core/common/string_repeat_cache.rs`
  - [ ] `tui/src/core/log/rolling_file_appender_impl.rs`
  - [ ] `tui/src/core/resilient_reactor_thread/process_isolated_tests/fixtures.rs`
  - [ ] `tui/src/core/ansi/terminal_raw_mode/integration_tests/test_poison_recovery.rs`
  - [ ] `tui/src/lib.rs`
  - [ ] `.agent/skills/concurrency-safety/SKILL.md`
  - [ ] `.agent/skills/concurrency-safety/patterns.md`

### Phase 24: Codebase-wide ScopedMutex Migration [REVIEW-PLAN]
...
### Phase 25: Codebase-wide rename of integration_tests module to avoid collisions [COMPLETE]
